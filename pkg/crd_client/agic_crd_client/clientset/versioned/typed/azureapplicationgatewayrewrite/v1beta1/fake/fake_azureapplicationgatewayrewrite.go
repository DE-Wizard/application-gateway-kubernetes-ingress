...
var azureapplicationgatewayrewritesResource = v1beta1.SchemeGroupVersion.WithResource("azureapplicationgatewayrewrites")

var azureapplicationgatewayrewritesKind = v1beta1.SchemeGroupVersion.WithKind("AzureApplicationGatewayRewrite")
...
func (c *FakeAzureApplicationGatewayRewrites) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(azureapplicationgatewayrewritesResource, c.ns, name, opts), &v1beta1.AzureApplicationGatewayRewrite{})
